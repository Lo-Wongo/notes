...
//Below are some weird results of this implicit type conversion using the double equal operator:
...
//JavaScript is not class based, but it is a prototype-based language. 
//This means that each object is linked to another object, its prototype, and it inherits its methods. 
//You can follow the prototype chain for each object up until you reach the null object which has no prototype. 
//We need to add a method to the global Array object, and we will do this by modifying the Array prototype.
...
//Now every array that is created will have the average method inherited along with every other Array method. 
//But, you need to be careful with modifying the prototype of an object, because you can mistakenly overwrite a common method.
...
//0.1 + 0.2 does not nicely come out to 0.3 but instead the result is actually 0.30000000000000004 
//because the computer cannot internally represent the correct number. One solution to get around this problem 
